...
import com.yuri.crowdfunding.bean.TPermissionMenu;
...
public interface TPermissionMenuMapper {
	...
	List<Integer> selectPermissionByMenuId(Integer menuId);

	int assignPermissionToMenu(@Param("menuId") Integer menuId, @Param("permissionIds") Integer[] permissionIds);
