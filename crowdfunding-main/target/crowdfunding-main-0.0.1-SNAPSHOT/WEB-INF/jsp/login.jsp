	...
	<div class="container">
		...
		<form id="loginForm" class="form-signin" role="form" action="doLogin" method="post">
			...
			<div class="form-group has-success has-feedback">
				...
				<span class="glyphicon glyphicon-userform-control-feedback"></span>
			</div>
			<div class="form-group has-success has-feedback">
				<input type="text" class="form-control" id="loginPassword" name="loginPassword" placeholder="请输入登录密码" style="margin-top: 10px;" />
