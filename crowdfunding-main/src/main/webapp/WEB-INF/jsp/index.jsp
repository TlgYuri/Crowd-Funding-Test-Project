...
<!-- 静态包含，编译前加载，只生成一个class文件 -->
<%@ include file="/WEB-INF/jsp/common/css.jsp" %>
<!-- 动态包含，编译后加载，单独生成class文件 -->
...
<body>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active" onclick="window.location.href='${PATH}/project'" style="cursor: pointer;">
			...
			<div class="item" onclick="window.location.href='${PATH}/project'" style="cursor: pointer;">
	...
	<div class="container marketing">
		...
		<div class="row">
			<div class="col-lg-4">
				...
				<p>
					<a class="btn btn-default" href="${PATH}/project" role="button">项目详情 &raquo;</a>
				</p>
			</div>
			<!-- /.col-lg-4 -->
			<div class="col-lg-4">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="thumbnail">
										...
										<div class="caption">
											<h3 class="break">
												<a href="${PATH}/project">活性富氢净水直饮机</a>
											</h3>
											<p>
											...
											<div>
												<span style="float: right;"> <i class="glyphicon glyphicon-star-empty"></i>
												</span> <span> <i class="glyphicon glyphicon-user" title="支持人数"></i> 12345
												</span>
											</div>
										</div>
									</div>
								...
								<div class="col-md-3">
									<div class="thumbnail">
										...
										<div class="caption">
											<h3 class="break">
												<a href="${PATH}/project">酷驰触控龙头，智享厨房黑科技</a>
											</h3>
											<p />
											<div style="float: left;">
												<i class="glyphicon glyphicon-screenshot" title="目标金额"></i> $20,000
								...
								<div class="col-md-3">
									<div class="thumbnail">
										...
										<div class="caption">
											<h3 class="break">
												<a href="${PATH}/project">小熊猫鱼眼全景安防摄像机</a>
											</h3>
											<p />
											<div style="float: left;">
												<i class="glyphicon glyphicon-screenshot" title="目标金额"></i> $20,000
								...
								<div class="col-md-3">
									<div class="thumbnail">
										...
										<div class="caption">
											<h3 class="break">
												<a href="${PATH}/project">一款精致的机械表</a>
											</h3>
											<p />
											<div style="float: left;">
												<i class="glyphicon glyphicon-screenshot" title="目标金额"></i> $20,000
